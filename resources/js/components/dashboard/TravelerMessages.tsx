...
import { Send, Search, Check, CheckCheck, Paperclip, MoreVertical, Home, Loader2, MessageSquare } from "lucide-react";
  ...
  const renderEmpty = () => (
    <div className="flex-1 flex flex-col items-center justify-center gap-3 text-center px-6">
      ...
      <p className="font-body text-sm text-muted-foreground">
        Vos échanges avec les hôtes apparaîtront ici après une réservation.
      </p>
    </div>
  );
              ...
              {!active ? (
                ...
                <>
                  ...
                  <div className="px-5 py-3.5 border-b border-border flex items-center gap-3 bg-muted/20">
                    ...
                    <Badge className="bg-primary/10 text-primary font-body text-xs border-0">
                      Hôte
                    </Badge>
